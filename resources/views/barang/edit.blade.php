    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form class="m-3" action="/data-barang/{{ $barang->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                      ...
                      <input name="harga" type="decimal" class="form-control" id="exampleFormControlInput2">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input name="deskripsi" type="text" class="form-control" id="exampleFormControlInput2">
                    </div>
